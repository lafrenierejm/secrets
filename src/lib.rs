...
fn predefined_secret_regexes() -> Vec<&'static str> {
    return vec![
        r"[A-Za-z]+://\S{3,50}:(\S{3,50})@[0-9A-Za-z[:punct:]]+", // URL
        ...
        r"[\dA-Za-z_-]*sq0i[a-z]{2}-[\dA-Za-z_-]{22,43}",         // Square
        r"[\dA-Za-z_-]*sq0c[a-z]{2}-[\dA-Za-z_-]{40,50}",         // Square
        ...
        // Private keys
        r"AGE-SECRET-KEY-[\dA-Z]{59}", // age secret key
